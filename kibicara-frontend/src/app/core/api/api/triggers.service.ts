...
export class TriggersService {
    ...
    /**
     * Trigger Create
     * Creates a new trigger for hood with id **hood_id**.  - **pattern**: Regular expression which is used to match a trigger.
     * @param hoodId 
     * @param bodyTrigger 
    ...
    public createTrigger(hoodId: number, bodyTrigger: BodyTrigger, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        if (bodyTrigger === null || bodyTrigger === undefined) {
    ...
    /**
     * Trigger Update
     * Updates trigger with id **trigger_id** for hood with id **hood_id**.  - **pattern**: Regular expression which is used to match a trigger
     * @param triggerId 
     * @param hoodId 
     * @param bodyTrigger 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
    ...
    public updateTrigger(triggerId: number, hoodId: number, bodyTrigger: BodyTrigger, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        if (hoodId === null || hoodId === undefined) {
            throw new Error('Required parameter hoodId was null or undefined when calling updateTrigger.');
        }
        if (bodyTrigger === null || bodyTrigger === undefined) {
